...
var vertices = []Vertex{
	{vec2{-0.5, -0.5}, vec3{1.0, 0.0, 0.0}, vec2{1.0, 0.0}},
	{vec2{0.5, -0.5}, vec3{0.0, 1.0, 0.0}, vec2{0.0, 0.0}},
	{vec2{0.5, 0.5}, vec3{0.0, 0.0, 1.0}, vec2{0.0, 1.0}},
	{vec2{-0.5, 0.5}, vec3{1.0, 1.0, 1.0}, vec2{1.0, 1.0}},
}
...
func (app *HelloTriangleApplication) createImageViews() error {
	...
	for i, image := range app.swapChainImages {
		imageView, err := app.createImageView(image, app.swapChainImageFormat)
		if err != nil {
			return err
		}
...
func (app *HelloTriangleApplication) createTextureImageView() error {
	var err error
	app.textureImageView, err = app.createImageView(app.textureImage, vk.FormatR8g8b8a8Srgb)
	return err
}

func (app *HelloTriangleApplication) createImageView(image vk.Image, format vk.Format) (vk.ImageView, error) {
